...
public class ExecutionPlanTest {
    ...
    public void buildsItBlocks() {
        ...
        assertThat(blocks.get(0).beforeBlocks().get(0).body(), is(beforeEachBlock));
        ...
        assertThat(blocks.get(1).beforeBlocks().get(0).body(), is(beforeEachBlock));
        ...
        assertThat(blocks.get(2).beforeBlocks().get(0).body(), is(beforeEachBlock));
        assertThat(blocks.get(2).beforeBlocks().get(1).body(), is(beforeEachBlockA));
